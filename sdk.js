/*1490235348,,JIT Construction: v2908818,en_US*/
                ...
                (function() {
                    var a = {}
                      ...
                      , h = function i(j, k, l, m, n) {
                        if (n) {
                            if (!n.callId)
                                n.callId = n.module + ':' + (n.line || 0) + ':' + (n.column || 0);
                            var o = n.callId;
                            a[o] = (a[o] || 0) + 1;
                        }
                        return l.apply(j, k);
 ...
 */
                                ...
                                l.stringify = function(ha, ia, ja) {
                                    ...
                                    if (typeof ia == "function" || typeof ia == "object" && ia)
                                        if (h.call(ia) == "[object Function]") {
                                            ...
                                            ma = {};
                                            for (na = 0,
                                            oa = ia.length; na < oa; pa = ia[na++],
                                            ((h.call(pa) == "[object String]" || h.call(pa) == "[object Number]") && (ma[pa] = 1)))
                                                ;
                                        }
                                    if (ja)
                            ...
                            if (!s) {
                                ...
                                w = function() {
                                    ...
                                    while (aa < ia) {
                                        ...
                                        if ("\t\r\n ".indexOf(ja) > -1) {
                                            ...
                                            if (ja >= "0" && ja <= "9") {
                                                if (ja == "0" && (ja = ha.charAt(aa + 1),
                                                ja >= "0" && ja <= "9"))
                                                    v();
                                                na = false;
                                                for (; aa < ia && (ja = ha.charAt(aa),
                                                ja >= "0" && ja <= "9"); aa++)
                                                    ;
                                                if (ha.charAt(aa) == ".") {
                                                    ma = ++aa;
                                                    for (; ma < ia && (ja = ha.charAt(ma),
                                                    ja >= "0" && ja <= "9"); ma++)
                                                        ;
                                                    if (ma == aa)
                                                        v();
                                                ...
                                                if (ja == "e" || ja == "E") {
                                                    ...
                                                    if (ja == "+" || ja == "-")
                                                        aa++;
                                                    for (ma = aa; ma < ia && (ja = ha.charAt(ma),
                                                    ja >= "0" && ja <= "9"); ma++)
                                                        ;
                                                    if (ma == aa)
                                                        v();
                                ...
                                l.parse = function(ha, ia) {
                                    ...
                                    if (w() != "$")
                                        v();
                                    aa = ba = null;
                                    return ia && h.call(ia) == "[object Function]" ? y((ca = {},
                                    ca[""] = ja,
                                    ca), "", ia) : ja;
                                }
                                ;
                ...
                __d('ES', ['ES5ArrayPrototype', 'ES5FunctionPrototype', 'ES5StringPrototype', 'ES5Array', 'ES5Object', 'ES5Date', 'JSON3', 'ES6Array', 'ES6Object', 'ES6ArrayPrototype', 'ES6DatePrototype', 'ES6Number', 'ES7StringPrototype', 'ES7Object'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    ...
                    function aa(ca) {
                        for (var da in ca) {
                            if (!Object.prototype.hasOwnProperty.call(ca, da))
                                continue;
                            var ea = ca[da]
                              , fa = da.split('.');
                            if (fa.length === 2) {
                            ...
                            for (var la in ea) {
                                if (!Object.prototype.hasOwnProperty.call(ea, la))
                                    continue;
                    ...
                    function ba(ca, da, ea) {
                        ...
                        if (typeof ga === 'function') {
                            for (var ha = arguments.length, ia = Array(ha > 3 ? ha - 3 : 0), ja = 3; ja < ha; ja++)
                                ia[ja - 3] = arguments[ja];
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/1FegrZjPbq3.js?version=42",
                    "Flash": {
                ...
                __d("ObservableMixin", [], function a(b, c, d, e, f, g) {
                    ...
                    h.prototype = {
                        ...
                        monitor: function i(j, k) {
                            if (!k()) {
                                var i = ES(function(l) {
                                    if (k.apply(k, arguments))
                                        this.unsubscribe(j, i);
                                }, "bind", true, this);
                                this.subscribe(j, i);
                            }
                            return this;
                ...
                __d('eprintf', [], function a(b, c, d, e, f, g) {
                    function h(i) {
                        ...
                        if (n !== m.length)
                            return h('eprintf args number mismatch: %s', ES('JSON', 'stringify', false, [i].concat(m)));
                        var o = 0;
                        return i.replace(/%s/g, function() {
                            return String(m[o++]);
                        });
                ...
                __d('ex', ['eprintf'], function a(b, c, d, e, f, g, h) {
                    function i(j) {
                        for (var k = arguments.length, l = Array(k > 1 ? k - 1 : 0), m = 1; m < k; m++)
                            l[m - 1] = arguments[m];
                        ...
                        if (o !== n.length)
                            return i('ex args number mismatch: %s', ES('JSON', 'stringify', false, [j].concat(n)));
                ...
                __d('URIBase', ['URIRFC3986', 'URISchemes', 'ex', 'invariant', 'setHostSubdomain'], function a(b, c, d, e, f, g, h, i, j, k, l) {
                    ...
                    function o(r, s, t, u) {
                        ...
                        if (v.fragment === '')
                            r.setForceFragmentSeparator(true);
                    ...
                    q.prototype.setDomain = function(r) {
                        'use strict';
                        if (m.test(r))
                            throw new Error(j('URI.setDomain: unsafe domain specified: %s for url %s', r, this.toString()));
                        this.$URIBase1 = r;
                        return this;
                    }
                    ;
                ...
                __d('Flash', ['DOMEventListener', 'DOMWrapper', 'QueryString', 'UserAgent_DEPRECATED', 'guid', 'htmlSpecialChars'], function a(b, c, d, e, f, g, h, i, j, k, l, m) {
                    ...
                    var u = {
                        embed: function v(w, x, y, z) {
                            ...
                            for (var ca in y)
                                if (Object.prototype.hasOwnProperty.call(y, ca) && y[ca])
                                    ba.push('<param name="' + m(ca) + '" value="' + m(y[ca]) + '">');
                        ...
                        getVersion: function v() {
                            var w = 'Shockwave Flash', x = 'application/x-shockwave-flash', y = 'ShockwaveFlash.ShockwaveFlash', z;
                            if (navigator.plugins && typeof navigator.plugins[w] == 'object') {
                                var aa = navigator.plugins[w].description;
                                if (aa && navigator.mimeTypes && navigator.mimeTypes[x] && navigator.mimeTypes[x].enabledPlugin)
                                    z = aa.match(/\d+/g);
                            }
                            if (!z)
                                try {
                        ...
                        return {
                            ...
                            init: function x(y) {
                                ...
                                h.add(s, 'message', p(function(event) {
                                    ...
                                    if (ca !== 'native' && !(v.test(location.hostname) || v.test(event.origin)))
                                        return;
                                    if (typeof ba != 'string') {
                ...
                __d('sdk.Event', [], function a(b, c, d, e, f, g) {
                    var h = {
                        ...
                        subscribe: function i(j, k) {
                            ...
                            if (!l[j]) {
                                l[j] = [k];
                            } else if (ES(l[j], 'indexOf', true, k) == -1)
                                l[j].push(k);
                ...
                __d('sdk.createIframe', ['DOMEventListener', 'getBlankIframeSrc', 'guid', 'hasNamePropertyBug', 'isNumberLike'], function a(b, c, d, e, f, g, h, i, j, k, l) {
                    function m(n) {
                        ...
                        var o, p = n.name || j(), q = n.root, r = n.style || {
                            border: 'none'
                        }, s = n.url, t = n.onload, u = n.onerror;
                        if (k()) {
                        ...
                        if (v.width && l(v.width))
                            o.width = v.width + 'px';
                        if (v.height && l(v.height))
                            o.height = v.height + 'px';
                        delete v.height;
                        delete v.width;
                        for (var w in v)
                ...
                __d('sdk.XD', ['sdk.Content', 'sdk.Event', 'Log', 'QueryString', 'Queue', 'sdk.RPC', 'sdk.Runtime', 'sdk.Scribe', 'sdk.URI', 'UrlMap', 'JSSDKXDConfig', 'XDM', 'isFacebookURI', 'sdk.createIframe', 'sdk.feature', 'guid'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w) {
                    var x = new l(), y = new l(), z = new l(), aa, ba, ca = w(), da = r.useCdn ? 'cdn' : 'www', ea = v('use_bundle', false) ? r.XdBundleUrl : r.XdUrl, fa = q.resolve(da, false) + ea, ga = q.resolve(da, true) + ea, ha = function va() {
                    ...
                    function ra(va, wa) {
                        ...
                        if (va.access_token)
                            n.setSecure(/^https/.test(ja));
                        if (va.cb) {
                            var ya = ua._callbacks[va.cb];
                            if (!ua._forever[va.cb])
                                delete ua._callbacks[va.cb];
                            if (ya)
                                ya(va);
                        }
                    }
                ...
                __d('sdk.Auth', ['sdk.Cookie', 'sdk.createIframe', 'DOMWrapper', 'sdk.feature', 'sdk.getContextType', 'guid', 'sdk.Impressions', 'Log', 'ObservableMixin', 'sdk.Runtime', 'sdk.Scribe', 'sdk.SignedRequest', 'UrlMap', 'sdk.URI', 'sdk.XD'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    var w = 'fblo_', x = 365 * 24 * 60 * 60 * 1000, y, z, aa = new p();
                    function ba(ja, ka) {
                        var la = q.getUserID()
                          , ma = '';
                        if (ja)
                        ...
                        if (pa || ra)
                            aa.inform('login', ua);
                        if (sa)
                            aa.inform('authresponse.change', ua);
                        if (ta)
                            aa.inform('status.change', ua);
                        return ua;
                    }
                    function ca() {
                        return y;
                    ...
                    function da(ja, ka, la) {
                        return function(ma) {
                            ...
                            if (ma && ma.access_token) {
                                ...
                                if (ma.granted_scopes)
                                    ka.grantedScopes = ma.granted_scopes;
                                if (q.getUseCookie()) {
                    ...
                    function ia(ja, ka) {
                        ...
                        if (ja)
                            if (!ka && ha == 'loaded') {
                                ...
                                aa.subscribe('FB.loginStatus', ja);
                        if (!ka && ha == 'loading')
                            return;
                        ha = 'loading';
                ...
                __d('ApiClient', ['ArgumentError', 'Assert', 'CORSRequest', 'FlashRequest', 'flattenObject', 'JSONPRequest', 'Log', 'ObservableMixin', 'QueryString', 'sprintf', 'sdk.URI', 'UrlMap', 'ApiClientConfig', 'invariant', 'sdk.safelyParseResponse'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    var w, x, y, z = m.MAX_QUERYSTRING_LENGTH, aa = {
                        get: true,
                        post: true,
                        'delete': true,
                        put: true
                        ...
                        stream_get: true,
                        users_getinfo: true
                    }, ca = ['jsonp', 'cors', 'flash'], da = [], ea = [], fa = null, ga = 0, ha = [], ia = 0, ja = 50, ka = 105440539523;
                    function la(va, wa, xa, ya) {
                        ...
                        ga++;
                        if (y)
                            xa = ES('Object', 'assign', false, {}, y, xa);
                        ...
                        if (cb)
                            bb.access_token = cb;
                        if (xa.routing_control)
                            bb.routing_control = xa.routing_control;
                    ...
                    function ma(va, wa, xa, ya, za, ab) {
                        if (ab && ab.error)
                            ta.inform('request.error', wa, xa, ya, ab, ES('Date', 'now', false) - za);
                    ...
                    function na(va) {
                        ...
                        i.isTrue(Object.prototype.hasOwnProperty.call(aa, ab), q('Invalid method passed to ApiClient: %s', ab));
                        var bb = ya['function'];
                        if (!bb)
                            n.warn('No callback passed to the ApiClient');
                        if (ya.object)
                            xa.addQueryData(l(ya.object));
                    ...
                    function oa() {
                        for (var va = arguments.length, wa = Array(va), xa = 0; xa < va; xa++)
                            wa[xa] = arguments[xa];
                        var ya = na(wa)
                          , za = ya.uri
                          , ab = ya.callback
                    ...
                    function pa(va) {
                        var wa = na(va), xa = wa.uri, ya = wa.callback, za = wa.params.method, ab, bb = xa.removeQueryData('method').toString();
                    ...
                    function ra() {
                        ...
                        oa('/', 'POST', {
                            ...
                            if (ES('Array', 'isArray', false, ab)) {
                                ...
                                ES(wa, 'forEach', true, function(bb) {
                                    return ( bb({
                                        error: {
                ...
                __d('FBEventsParamList', [], function a(b, c, d, e, f, g) {
                    ...
                    function k(l) {
                        if (typeof JSON === 'undefined' || JSON === null || !ES('JSON', 'stringify', false)) {
                            ...
                            return ES('JSON', 'stringify', false, l);
                    }
                    f.exports = j;
                }, null);
                ...
                __d('sdk.AppEvents', ['Assert', 'sdk.Event', 'sdk.Impressions', 'sdk.Runtime', 'FBAppEvents', 'sdk.Auth'], function a(b, c, d, e, f, g, h, i, j, k, l, m) {
                    var n = {
                      ...
                      , q = 40
                      , r = '^[0-9a-zA-Z_]+[0-9a-zA-Z _-]*$';
                    function s(z, aa, ba, ca) {
                        var da = {
                            ae: 1,
                            ev: aa,
                            vts: ba,
                        ...
                        j.impression({
                            api_key: z,
                            payload: ES('JSON', 'stringify', false, da)
                        });
                    }
                    function t(z, aa, ba, ca) {
                        var da = m.getAuthResponse()
                          , ea = da && da.accessToken ? da.accessToken : null;
                        l.logEvent(z, aa, ca, ba, ea);
                    }
                    function u(z, aa, ba, ca) {
                        h.isTrue(v(aa), 'Invalid event name: ' + aa + '. ' + 'It must be between 1 and ' + q + ' characters, ' + 'and must be contain only alphanumerics, _, - or spaces, ' + 'starting with alphanumeric or _.');
                        if (k.isCanvasEnvironment()) {
                            s.apply(null, arguments);
                        } else
                            t.apply(null, arguments);
                    }
                    function v(z) {
                        if (z === null || z.length === 0 || z.length > q || !new RegExp(r).test(z))
                            return false;
                        return true;
                    }
                    function w(z, aa, ba, ca) {
                        var da = {};
                        da[p.CURRENCY] = ba;
                        u(z, o.PURCHASED, aa, babelHelpers['extends']({}, ca, da));
                    }
                    function x(z) {
                        u(z, o.ACTIVATED_APP);
                    }
                    ...
                    i.subscribe('init:post', function(z) {
                        if (k.getClientID()) {
                            if (z.autoLogAppEvents !== undefined) {
                                h.isBoolean(z.autoLogAppEvents, 'Type of property autoLogAppEvents must be boolean');
                                k.setAutoLogAppEvents(z.autoLogAppEvents);
                            }
                            if (k.getAutoLogAppEvents())
                                y(k.getClientID());
                        }
                    });
                    f.exports = {
                      ...
                      , z = {
                        ...
                        _createMobileLoader: function aa() {
                            ...
                            if (p.nativeApp()) {
                                ...
                                ba = '<div class="dialog_header">' + '<table>' + '  <tbody>' + '    <tr>' + '      <td class="header_left">' + '        <label class="touchable_button">' + '          <input type="submit" value="' + q._("Cancel") + '"' + '            id="fb_dialog_loader_close"/>' + '        </label>' + '      </td>' + '      <td class="header_center">' + '        <div>' + '         ' + q._("Loading...") + '        </div>' + '      </td>' + '      <td class="header_right">' + '      </td>' + '    </tr>' + '  </tbody>' + '</table>' + '</div>';
                            return z.create({
                        ...
                        showLoader: function aa(ba, ca) {
                            ...
                            if (!z._loaderEl)
                                z._loaderEl = z._findRoot(p.mobile() ? z._createMobileLoader() : z._createWWWLoader(ca));
                        ...
                        _setDialogSizes: function aa() {
                            ...
                            for (var ca in z._dialogs)
                                if (Object.prototype.hasOwnProperty.call(z._dialogs, ca)) {
                        ...
                        _handleOrientationChange: function aa() {
                            ...
                            if (z.isTabletStyle()) {
                                ...
                                for (var da in z._dialogs)
                                    if (Object.prototype.hasOwnProperty.call(z._dialogs, da)) {
                                        var ea = document.getElementById(da);
                                        if (ea)
                                            ea.style.width = ca + 'px';
                                    }
                            }
                        },
                        ...
                        create: function aa(ba) {
                            ...
                            if (ba.visible)
                                z.show(ca.dialogElement);
                            if (typeof ba.styles === 'object')
                                ES('Object', 'assign', false, ca.dialogElement.style, ba.styles);
                        ...
                        show: function aa(ba) {
                            ...
                            if (ca) {
                                ...
                                z._stack.push(ca);
                                if ('fbCallID'in ba)
                                    z.get(ba.fbCallID).inform('iframe_show').trackEvent('show');
                            }
                        },
                        hide: function aa(ba) {
                            var ca = z._findRoot(ba);
                            ...
                            if (ca == z._active) {
                                ...
                                z._hideTabletOverlay();
                                if ('fbCallID'in ba)
                                    z.get(ba.fbCallID).inform('iframe_hide').trackEvent('hide');
                            }
                        },
                    ...
                    var l = {
                        ...
                        isAllowed: function m(n) {
                            if (!n)
                                return false;
                            if (typeof n === 'number')
                                return n in l._allowedRecipients;
                            if (typeof n === 'string')
                                n = n.split(',');
                ...
                __d('sdk.UIServer', ['sdk.Auth', 'sdk.Content', 'sdk.DOM', 'sdk.Dialog', 'sdk.Event', 'sdk.Frictionless', 'Log', 'sdk.Native', 'QueryString', 'sdk.RPC', 'sdk.Runtime', 'JSSDKConfig', 'sdk.UA', 'UrlMap', 'sdk.XD', 'createObjectFrom', 'sdk.feature', 'sdk.fbt', 'flattenObject', 'sdk.getContextType', 'guid', 'insertIframe', 'sdk.openMessenger', 'resolveURI'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ba, ca, da, ea) {
                    var fa = {
                        transform: function la(ma) {
                            if (ma.params.display === 'touch' && ka.canIframe(ma.params) && window.postMessage) {
                                ...
                                if (!t.nativeApp())
                                    ma.params.in_iframe = 1;
                                return ma;
                            } else
                                return ka.genericTransform(ma);
                        },
                    ...
                    var ka = {
                        ...
                        genericTransform: function la(ma) {
                            if (ma.params.display == 'dialog' || ma.params.display == 'iframe')
                                ES('Object', 'assign', false, ma.params, {
                                    display: 'iframe',
                        ...
                        checkOauthDisplay: function la(ma) {
                            ...
                            for (var pa = 0; pa < oa.length; pa++)
                                if (!s.initSitevars.iframePermissions[ES(oa[pa], 'trim', true)])
                                    return 'popup';
                            return ma.display;
                        },
                        prepareCall: function la(ma, na) {
                            var oa = ma.method.toLowerCase()
                              , pa = Object.prototype.hasOwnProperty.call(ka.Methods, oa) ? ES('Object', 'assign', false, {}, ka.Methods[oa]) : {}
                              , qa = ba()
                            ...
                            if (!pa.url)
                                pa.url = 'dialog/' + oa;
                            if ((pa.url == 'dialog/oauth' || pa.url == 'dialog/permissions.request') && (ma.display == 'iframe' || ma.display == 'touch' && ma.in_iframe))
                                ma.display = ka.checkOauthDisplay(ma);
                            if (ma.display == 'popup' && !pa.require_access_token)
                                delete ma.access_token;
                            if (r.getIsVersioned() && pa.url.substring(0, 7) === 'dialog/')
                            ...
                            var va = pa.getXdRelation || ka.getXdRelation
                              , wa = va(ta.params);
                            if (!(ta.id in ka._defaultCb) && !('next'in ta.params) && !('redirect_uri'in ta.params))
                                ta.params.next = ka._xdResult(ta.cb, ta.id, wa, true);
                            if (wa === 'parent')
                                ES('Object', 'assign', false, ta.params, {
                        ...
                        getDisplayMode: function la(ma, na) {
                            ...
                            if (ma.connectDisplay && !oa)
                                return ma.connectDisplay;
                        ...
                        getXdRelation: function la(ma) {
                            var na = ma.display;
                            if (na === 'popup' || na === 'touch')
                                return 'opener';
                            if (na === 'dialog' || na === 'iframe' || na === 'hidden' || na === 'none')
                                return 'parent';
                            if (na === 'async')
                        ...
                        popup: function la(ma) {
                            ...
                            if (ma.name == 'permissions.request' || ma.name == 'permissions.oauth')
                                wa.push('location=1,toolbar=0');
                            wa = wa.join(',');
                            var la;
                            if (ma.post) {
                        ...
                        _handleResizeMessage: function la(ma, na) {
                            ...
                            if (!oa)
                                return;
                            if (na.height)
                                oa.style.height = na.height + 'px';
                            if (na.width)
                                oa.style.width = na.width + 'px';
                        ...
                        _popupMonitor: function la() {
                            ...
                            for (var na in ka._loadedNodes)
                                if (Object.prototype.hasOwnProperty.call(ka._loadedNodes, na) && na in ka._defaultCb) {
                                    var oa = ka._loadedNodes[na];
                                    if (oa.type != 'popup' && oa.type != 'native')
                                        continue;
                                    var pa = oa.node;
                                    try {
                                        if (pa.closed) {
                        ...
                        _xdRecv: function la(ma, na) {
                            ...
                            if (oa)
                                ...
                                } else if (j.containsCss(oa, 'FB_UI_Dialog'))
                                    k.remove(oa);
                ...
                __d('sdk.MBasicInitializer', ['sdk.DOM', 'sdk.Runtime', 'sdk.UA', 'sdk.URI', 'UrlMap', 'sdk.fbt', 'sdk.feature'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    var o = function q() {
                        ...
                        if (!n('js_sdk_mbasic_share_plugin_init', false))
                            return;
                ...
                __d('sdk.init', ['sdk.Cookie', 'sdk.ErrorHandling', 'sdk.Event', 'sdk.Impressions', 'Log', 'ManagedError', 'sdk.MBasicInitializer', 'sdk.PlatformVersioning', 'QueryString', 'sdk.Runtime', 'sdk.UA', 'sdk.URI', 'sdk.feature'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
                    ...
                    function v(w) {
                        ...
                        if (w.cookie) {
                            q.setUseCookie(true);
                            if (typeof w.cookie === 'string')
                                h.setDomain(w.cookie);
                        }
                        if (w.kidDirectedSite)
                            q.setKidDirectedSite(true);
                        q.setInitialized(true);
                        if (t('js_sdk_impression_on_load', true))
                            k.log(115, {});
                        if (r.mBasic())
                            n.init();
                        j.fire('init:post', w);
                    ...
                    function z(ha, ia, ja) {
                        if (ia || ia === 0)
                            if (ia === '100%') {
                                ...
                                ha.style.width = ia + 'px';
                        if (ja || ja === 0)
                            ha.style.height = ja + 'px';
                    }
                    function aa(ha) {
                        return function(ia) {
                            var ja = {
                    ...
                    var ga = p.extend({
                        constructor: function ha(ia, ja, ka, la) {
                            ...
                            this.subscribe('xd.resize.iframe', ES(function(ra) {
                                if (ra.reposition === 'true' && v('reposition_iframe', false))
                ...
                __d('sdk.XFBML.IframeWidget', ['sdk.Arbiter', 'sdk.Auth', 'sdk.Content', 'sdk.DOM', 'sdk.Event', 'sdk.XFBML.Element', 'guid', 'insertIframe', 'QueryString', 'sdk.Runtime', 'sdk.ui', 'UrlMap', 'sdk.XD'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
                    var u = m.extend({
                        ...
                        _setupAuthRefresh: function y() {
                            i.getLoginStatus(ES(function(z) {
                                ...
                                l.subscribe('auth.statusChange', ES(function(ba) {
                                    if (!this.isValid())
                                        return;
                                    if (aa == 'unknown' || ba.status == 'unknown')
                                        this.process(true);
                                    aa = ba.status;
                                }, 'bind', true, this));
                            }, 'bind', true, this));
                        ...
                        _resizeIframe: function y(z) {
                            ...
                            if (z.reposition === "true")
                                this._repositionIframe(z);
                            ...
                            if (!r.href) {
                                ...
                                if (!r.xid) {
                                    ...
                                    if (s > 0) {
                                        ...
                                        r.xid = encodeURIComponent(document.URL);
                                }
                                if (r.migrated)
                                    r.href = n.resolve('www') + '/plugins/comments_v1.php?' + 'app_id=' + k.getClientID() + '&xid=' + encodeURIComponent(r.xid) + '&url=' + encodeURIComponent(r.url);
                            } else {
                ...
                __d('sdk.Helper', ['sdk.ErrorHandling', 'sdk.Event', 'UrlMap', 'safeEval', 'sprintf'], function a(b, c, d, e, f, g, h, i, j, k, l) {
                    var m = {
                        ...
                        getProfileLink: function n(o, p, q) {
                            if (!q && o)
                                q = l('%s/profile.php?id=%s', j.resolve('www'), o.uid || o.id);
                            if (q)
                                p = l('<a class="fb_link" href="%s">%s</a>', q, p);
                            return p;
                        },
                ...
                __d('sdk.XFBML.LoginButton', ['sdk.Helper', 'IframePlugin', 'Log', 'sdk.ui'], function a(b, c, d, e, f, g, h, i, j, k) {
                    var l = i.extend({
                        constructor: function m(n, o, p, q) {
                            ...
                            this.subscribe('xd.login_button_dialog_open', function(t) {
                      ...
                      , p = k.extend({
                        ...
                        _renderOther: function q(r) {
                            ...
                            if (this._uid == n.getUserID() && this._getBoolAttribute('use-you', true)) {
                                ...
                                if (null === r.first_name)
                                    r.first_name = '';
                                if (null === r.last_name)
                                    r.last_name = '';
                                if (this._firstnameonly && r.first_name !== undefined) {
                                    s = i(r.first_name);
                                } else if (this._lastnameonly && r.last_name !== undefined)
                                    s = i(r.last_name);
                                if (!s)
                                    s = i(r.name);
                                if (s !== '' && this._possessive)
                                    s += '\'s';
                            }
                            if (!s)
                        ...
                        constructor: function s(t, u, v, w) {
                            ...
                            this.subscribe('xd.savePluginGetBlankIframe', ES(function(y) {
                                var z = void 0
                                  ...
                                  , ca = function ha(ia) {
                                    if (ia)
                                        j.removeCss(ia, 'fb_invisible');
                                }
                                  , da = function ha(ia) {
                                    if (ia)
                                        j.addCss(ia, 'fb_invisible');
                                };
                                if (x) {
                            ...
                            if (w) {
                                (function() {
                                    var x = function y(z, aa) {
                                        if (aa != null)
                                            i.setDialogPositionToCenter(aa, w);
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2908818","namespace":"FB","message":"' + e.message + '"}}');
}
